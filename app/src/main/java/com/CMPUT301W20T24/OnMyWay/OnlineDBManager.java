...
public class OnlineDBManager {
    private static final String TAG = "OMW/OnlineDBManager";  // Use this tag for call Log.d()
    ...
    /**
     * Constructor for OnlineDBManager. Initializes auth and db which are singletons
     * @author John
     */
    public OnlineDBManager() {
